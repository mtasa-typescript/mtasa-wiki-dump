...
'''Note:''' setCameraTarget will behave strangely if you use hydraulics (upgrade id: 1087) server sided and when your camera target is the player inside the vehicle with hydraulics and if the player is not you. """
    ...
    CompoundOOPData(
        ...
        client=[
            FunctionOOP(
                description=None,
                base_function_name="getVehicleCurrentGear",
                class_name='vehicle',
                method=FunctionData(
            signature=FunctionSignature(
                name='getGear',
...
<syntaxhighlight lang="lua">{ front_axle = 0.8, rear_axle = 0.7 }</syntaxhighlight> """
    ...
    CompoundOOPData(
        server=[
            FunctionOOP(
                description=None,
                base_function_name="getVehicleTurnVelocity",
                class_name='vehicle',
                method=FunctionData(
            signature=FunctionSignature(
                name='getTurnVelocity',
                return_types=FunctionReturnTypes(
                    return_types=[
                        FunctionType(
                                    names=['float'],
...
''NOTE:'' Settings are not applicable for all vehicles of these types, for instance panel 0 effects a Dodo, but does nothing to a hydra. """,
    ...
    CompoundOOPData(
        server=[
            FunctionOOP(
                description=None,
                base_function_name="setVehicleTurnVelocity",
                class_name='vehicle',
                method=FunctionData(
            signature=FunctionSignature(
                name='setTurnVelocity',
                return_types=FunctionReturnTypes(
                    return_types=[
                        FunctionType(
                                    names=['bool'],
