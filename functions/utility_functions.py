    ...
    CompoundFunctionData(
        server=[
            ...
            docs=FunctionDoc(
                ...
                result='returns 2 strings if successful: private key and public key. otherwise returns false' ,
            ),
            url='generateKeyPair',
        )
        ],
